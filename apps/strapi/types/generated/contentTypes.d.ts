...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Editorial posts for /blog";
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<["reading", "authors", "publishing", "community"]> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<"reading">;
    cover: Schema.Attribute.Media<"images">;
    coverHue: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<"oneToMany", "api::blog-post.blog-post"> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    readingMinutes: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<5>;
...
export interface ApiBookBook extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Catalog title for the Novella shop";
    displayName: "Book";
    pluralName: "books";
    singularName: "book";
  };
  ...
  attributes: {
    author: Schema.Attribute.String & Schema.Attribute.Required;
    bookId: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
    category: Schema.Attribute.Enumeration<["fiction", "nonfiction", "nature", "literary"]> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<"fiction">;
    collections: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<[]>;
    cover: Schema.Attribute.Media<"images">;
    coverHue: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<200>;
    coverImageSrc: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    ...
    inventoryCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
export interface ApiBrowseCategoryBrowseCategory extends Struct.CollectionTypeSchema {
  collectionName: "browse_categories";
  info: {
    description: "Home and /categories shelf tiles";
    displayName: "Browse category";
    pluralName: "browse-categories";
    singularName: "browse-category";
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    children: Schema.Attribute.Component<"category.browse-subcategory", true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    href: Schema.Attribute.String & Schema.Attribute.Required;
    hue: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<200>;
    imageSrc: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::browse-category.browse-category"> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: "Storefront copy, contact, and bank transfer details";
  ...
  attributes: {
    ...
    siteName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<"Novella">;
    tagline: Schema.Attribute.String & Schema.Attribute.Required;
    transferNote: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
  };
}
...
declare module "@strapi/strapi" {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      "api::browse-category.browse-category": ApiBrowseCategoryBrowseCategory;
